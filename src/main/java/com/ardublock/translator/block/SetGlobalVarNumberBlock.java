...
public class SetGlobalVarNumberBlock extends TranslatorBlock
{
	protected SetGlobalVarNumberBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
