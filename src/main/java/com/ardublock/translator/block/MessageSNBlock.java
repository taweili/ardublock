...
public class MessageSNBlock extends TranslatorBlock
{
	protected MessageSNBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
