...
public class dcmotor_release extends TranslatorBlock
{

	public dcmotor_release(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
