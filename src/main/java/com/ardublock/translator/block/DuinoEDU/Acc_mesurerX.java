...
public class Acc_mesurerX  extends TranslatorBlock {

	public Acc_mesurerX (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	//@Override
		public String toCode() throws SocketNullException, SubroutineNotDeclaredException
		{
			...
			String ret =  "monAccelerometre.mesurerX()";
