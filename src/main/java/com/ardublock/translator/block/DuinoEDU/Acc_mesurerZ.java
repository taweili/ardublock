...
public class Acc_mesurerZ  extends TranslatorBlock {

	public Acc_mesurerZ (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	//@Override
		public String toCode() throws SocketNullException, SubroutineNotDeclaredException
		{
			...
			String ret =  "monAccelerometre.mesurerZ()";
