...
public class FsShieldDirect extends TranslatorBlock {

	public FsShieldDirect(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
