...
public class FsShieldMotor extends TranslatorBlock {

	public FsShieldMotor(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
