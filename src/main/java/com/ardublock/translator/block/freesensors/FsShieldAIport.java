...
public class FsShieldAIport extends TranslatorBlock {

	public FsShieldAIport(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
