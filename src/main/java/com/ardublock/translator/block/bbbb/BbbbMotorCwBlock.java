...
public class BbbbMotorCwBlock extends TranslatorBlock
{

	public BbbbMotorCwBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		return String.format("bbbbMotor(1, %s);\n", speed);
	}
