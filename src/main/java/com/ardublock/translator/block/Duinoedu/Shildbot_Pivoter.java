...
public class Shildbot_Pivoter  extends TranslatorBlock {

	public Shildbot_Pivoter (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
