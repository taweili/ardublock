...
public class Hand_positionY extends TranslatorBlock
{

	public Hand_positionY(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
	...
	public String toCode() throws SocketNullException {
		...
		return codePrefix + "monSerialLeap.readNbr(CANAL81)" + codeSuffix;
	}
