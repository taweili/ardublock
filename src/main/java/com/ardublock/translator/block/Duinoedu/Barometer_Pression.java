...
public class Barometer_Pression  extends TranslatorBlock {

	public Barometer_Pression (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
