...
public class Hand_positionX extends TranslatorBlock
{

	public Hand_positionX(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
	...
	public String toCode() throws SocketNullException {
		...
		return codePrefix + "monSerialLeap.readNbr(CANAL80)" + codeSuffix;
	}
