...
public class Nunchuck_BoutonZ  extends TranslatorBlock {

	public Nunchuck_BoutonZ (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	//@Override
		...
		{		
			...
			return codePrefix +"monNunchuck.lireBoutonZ()" + codeSuffix;	
		}
}
