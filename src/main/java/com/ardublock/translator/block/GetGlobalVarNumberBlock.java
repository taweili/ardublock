...
public class GetGlobalVarNumberBlock extends TranslatorBlock
{
	protected GetGlobalVarNumberBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
